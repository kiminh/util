...
namespace fea {
	...
	public:
		...
		int get_slot_index(){
			return 	std::stoi(m_fea_arg.slot);
		}
		...
		void set_is_extract(bool value){
			this->is_extract = value;
		}
		bool get_is_extract(){
	...
	protected:
        ...
        virtual void commit_anycombine_fea(vector<vector<uint32_t> > fea_sign_vec,fea_result &result);
