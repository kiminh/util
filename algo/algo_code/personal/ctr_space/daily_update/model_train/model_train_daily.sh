...
$ROOT_DIR/ftrl/bin/ftrl $LOCAL_SHITU_INS/shitu_ins l1_reg=1 l2_reg=0 alpha=0.02 beta=1 \
...
mv $MODEL_PATH/lr_model.dat.${TODAY} $ROOT_DIR/model/lr_model.dat.${TODAY}
