...
common_file="/home/ad_user/ling.fang/script/tools/common.sh"
source $common_file
bash /home/ad_user/kinit_ad_user.sh
...
[ $# -eq 2 ] && JOB_TAG=$2 || JOB_TAG="ecommerce2"
ROOT_DIR=`pwd`
...
echo $INPUTDIR
OUTPUTDIR="/user/${USER_NAME}/ocpc/model_train_${JOB_TAG}/shitu/${DATE}/"
...
function hadoop_run() {
    ...
    $HADOOP_HOME/bin/hadoop jar /usr/local/hadoop-2.6.3/share/hadoop/tools/lib/hadoop-streaming-2.6.3.jar \
        ...
        -mapper 'python script/mapper_ecommerce22.py' \
...
ADFEA_DIR=/user/${USER_NAME}/ocpc/model_train_${JOB_TAG}/shitu/adfea/
ADFEA_PATH=$ADFEA_DIR/${DATE}/
INS_DIR=/user/${USER_NAME}/ocpc/model_train_${JOB_TAG}/shitu/ins/
INS_PATH=$INS_DIR/${DATE}/
STATINFO_DIR=/user/${USER_NAME}/ocpc/model_train_${JOB_TAG}/shitu/statinfo/
STATINFO_PATH=$STATINFO_DIR/${DATE}/
PLANCLKTRANS_DIR=/user/${USER_NAME}/ocpc/model_train_${JOB_TAG}/shitu/planclktrans/
PLANCLKTRANS_PATH=$PLANCLKTRANS_DIR/${DATE}/
SHITULOG_DIR=/user/${USER_NAME}/ocpc/model_train_${JOB_TAG}/shitu/log/
