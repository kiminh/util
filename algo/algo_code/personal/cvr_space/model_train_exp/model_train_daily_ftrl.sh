...
hdfs_shitu_ins_path=/user/${USER_NAME}/ocpc/model_train_exp/shitu/ins/
...
./ftrl/bin/ftrl ${shitu_ins} alpha=0.03 beta=1 l1_reg=0.1 l2_reg=0. \
...
python utils/sms_sender.py "[$VERSION] exp ftrl cvr model train success!"
exit 0
