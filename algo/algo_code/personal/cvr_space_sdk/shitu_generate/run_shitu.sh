...
echo $INPUTDIR
OUTPUTDIR="/user/${USER_NAME}/ocpc_sdk/model_train${JOB_TAG}/shitu/${DATE}/"
...
ADFEA_DIR=/user/${USER_NAME}/ocpc_sdk/model_train${JOB_TAG}/shitu/adfea/
ADFEA_PATH=$ADFEA_DIR/${DATE}/
INS_DIR=/user/${USER_NAME}/ocpc_sdk/model_train${JOB_TAG}/shitu/ins/
INS_PATH=$INS_DIR/${DATE}/
STATINFO_DIR=/user/${USER_NAME}/ocpc_sdk/model_train${JOB_TAG}/shitu/statinfo/
STATINFO_PATH=$STATINFO_DIR/${DATE}/
APPCLKTRANS_DIR=/user/${USER_NAME}/ocpc_sdk/model_train${JOB_TAG}/shitu/appclktrans/
APPCLKTRANS_PATH=$APPCLKTRANS_DIR/${DATE}/
SHITULOG_DIR=/user/${USER_NAME}/ocpc_sdk/model_train${JOB_TAG}/shitu/log/
