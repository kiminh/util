...
#INPUTDIR="-input \"/user/${USER_NAME}/ctr_space/ed_join_click_exp_hour/join/${DATE}/\" "${INPUTDIR}
...
TASK_NAME="naga_ctr_generate_shitu_log_exp"
...
ADFEA_DIR=/user/${USER_NAME}/ctr_space/hour_model_train${JOB_TAG}/shitu/adfea/
ADFEA_PATH=$ADFEA_DIR/${DATE}/
INS_DIR=/user/${USER_NAME}/ctr_space/hour_model_train${JOB_TAG}/shitu/ins/
INS_PATH=$INS_DIR/${DATE}/
STATINFO_DIR=/user/${USER_NAME}/ctr_space/hour_model_train${JOB_TAG}/shitu/statinfo/
