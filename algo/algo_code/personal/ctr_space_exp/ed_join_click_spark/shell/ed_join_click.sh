...
JOIN_PATH="/user/$USER_NAME/ctr_space/ed_join_click_exp/join/$DATE"
YESTDAY_JOIN_PATH="/user/$USER_NAME/ctr_space/ed_join_click_exp/join/$YESTDAY"
UNJOIN_PATH="/user/$USER_NAME/ctr_space/ed_join_click_exp/unjoin/$DATE"

#$HADOOP_HOME/bin/hadoop fs -rm -r -f $JOIN_PATH $YESTDAY_JOIN_PATH $UNJOIN_PATH
$HADOOP_HOME/bin/hadoop fs -rm -r -f $JOIN_PATH $UNJOIN_PATH $STAT_PATH
