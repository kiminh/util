...
JOIN_PATH="/user/$USER_NAME/naga_interactive/ocpc/click_join_trans${JOB_TAG}/join_path/$VERSION"
PLAN_PATH="/user/$USER_NAME/naga_interactive/ocpc/click_join_trans${JOB_TAG}/plan_path/$VERSION"
PKG_PATH="/user/$USER_NAME/naga_interactive/ocpc/click_join_trans${JOB_TAG}/pkg_path/$VERSION"
...
$sparksubmit ${JOB_PATH}/click_join_trans_hour.py $JOIN_PATH $PLAN_PATH $PKG_PATH $DATE
