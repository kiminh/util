...
for i in `seq 1 10`;do
    ...
    DATE_LIST+=${day},
    done_file="/user/${USER_NAME}/naga_interactive/ctr2_space/model_train${JOB_TAG}/shitu/ins/${day}/_SUCCESS"
    loop_check $done_file 140 1
done
DATE_LIST+="}"
INPUTDIR="/user/${USER_NAME}/naga_interactive/ctr2_space/model_train${JOB_TAG}/shitu/ins/${DATE_LIST}"
OUTPUTDIR="/user/${USER_NAME}/naga_interactive/ctr2_space/model_train${JOB_TAG}/shitu_shuffle/${DATE}/"
