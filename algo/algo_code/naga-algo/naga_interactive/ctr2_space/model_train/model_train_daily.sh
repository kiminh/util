...
SHITU_SHUFFLE="/user/${USER_NAME}/naga_interactive/ctr2_space/model_train${JOB_TAG}/shitu_shuffle/"
...
[ $? -ne 0 ] && { alarm "Naga Interactive CTR2 Model Daily Update" "ftrl train error"; exit 1; }

mv $MODEL_PATH/lr_model.dat.${TODAY} $ROOT_DIR/daily_model/lr_model.dat.${TODAY}
