...
INPUTDIR="-input \"/user/$USER_NAME/naga_interactive/ctr2_space/ed_join_click/join/${DATE}/\" "${INPUTDIR}
OUTPUTDIR="/user/${USER_NAME}/naga_interactive/ctr2_space/model_train${JOB_TAG}/shitu/${DATE}/"
done_file="/user/$USER_NAME/naga_interactive/ctr2_space/ed_join_click/join/${DATE}/_SUCCESS"
...
ADFEA_DIR=/user/${USER_NAME}/naga_interactive/ctr2_space/model_train${JOB_TAG}/shitu/adfea/
ADFEA_PATH=$ADFEA_DIR/${DATE}/
INS_DIR=/user/${USER_NAME}/naga_interactive/ctr2_space/model_train${JOB_TAG}/shitu/ins/
INS_PATH=$INS_DIR/${DATE}/
STATINFO_DIR=/user/${USER_NAME}/naga_interactive/ctr2_space/model_train${JOB_TAG}/shitu/statinfo/
