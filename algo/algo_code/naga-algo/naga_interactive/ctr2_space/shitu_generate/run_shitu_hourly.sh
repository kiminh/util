...
INPUTDIR="-input \"/user/$USER_NAME/naga_interactive/ctr2_space/ed_join_click_hour/join/${DATE}/\" "${INPUTDIR}
OUTPUTDIR="/user/${USER_NAME}/naga_interactive/ctr2_space/model_train_hour${JOB_TAG}/shitu/${DATE}/"
done_file="/user/$USER_NAME/naga_interactive/ctr2_space/ed_join_click_hour/join/${DATE}/_SUCCESS"
loop_check $done_file 400 1

OWNER_INFO="$USER_NAME@cootek.cn"
TASK_NAME="naga DSP interactive: ctr2_generate_shitu_log"
...
ADFEA_DIR=/user/${USER_NAME}/naga_interactive/ctr2_space/model_train_hour${JOB_TAG}/shitu/adfea/
ADFEA_PATH=$ADFEA_DIR/${DATE}/
INS_DIR=/user/${USER_NAME}/naga_interactive/ctr2_space/model_train_hour${JOB_TAG}/shitu/ins/
INS_PATH=$INS_DIR/${DATE}/
STATINFO_DIR=/user/${USER_NAME}/naga_interactive/ctr2_space/model_train_hour${JOB_TAG}/shitu/statinfo/
