...
[ $? -ne 0 ] && { alarm "Naga Interactive CTR1 Model Hourly Update" "ftrl model train error!"; exit 1; }
...
[ $? -ne 0 ] && { alarm "Naga Interactive CTR1 Model Hourly Update" "model push online $VERSION error!"; exit 1; }
exit 0
