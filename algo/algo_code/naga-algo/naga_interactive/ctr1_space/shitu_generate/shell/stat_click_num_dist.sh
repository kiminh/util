...
OUT_PATH="/user/$USER_NAME/naga_interactive/ctr1_space/click_num_dist/$DATE"
OUT_PATH1="/user/$USER_NAME/naga_interactive/ctr1_space/show_rate/$DATE"
...
$sparksubmit ${JOB_PATH}/stat_click_num_dist.py $DATA_PATH $OUT_PATH $OUT_PATH1
