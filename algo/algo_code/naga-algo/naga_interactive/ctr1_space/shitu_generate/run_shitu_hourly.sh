...
INPUTDIR="-input \"/user/$USER_NAME/naga_interactive/ctr1_space/ed_join_click_hour/join/${DATE}/\" "${INPUTDIR}
OUTPUTDIR="/user/${USER_NAME}/naga_interactive/ctr1_space/model_train_hour${JOB_TAG}/shitu/${DATE}/"
done_file="/user/$USER_NAME/naga_interactive/ctr1_space/ed_join_click_hour/join/${DATE}/_SUCCESS"
...
ADFEA_DIR=/user/${USER_NAME}/naga_interactive/ctr1_space/model_train_hour${JOB_TAG}/shitu/adfea/
ADFEA_PATH=$ADFEA_DIR/${DATE}/
INS_DIR=/user/${USER_NAME}/naga_interactive/ctr1_space/model_train_hour${JOB_TAG}/shitu/ins/
INS_PATH=$INS_DIR/${DATE}/
STATINFO_DIR=/user/${USER_NAME}/naga_interactive/ctr1_space/model_train_hour${JOB_TAG}/shitu/statinfo/
