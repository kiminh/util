...
done_file="/user/$USER_NAME/naga_interactive/ocpc_ecom/shitu_log${JOB_TAG}/${DATE}/"
INPUTDIR="-input \"/user/$USER_NAME/naga_interactive/ocpc_ecom/shitu_log${JOB_TAG}/${DATE}/\" "${INPUTDIR}
OUTPUTDIR="/user/${USER_NAME}/naga_interactive/ocpc_ecom/model_train${JOB_TAG}/shitu/${DATE}/"
loop_check $done_file 140 1

OWNER_INFO="$USER_NAME@cootek.cn"
TASK_NAME="naga_interactive_cvr_ecom_generate_shitu_log"
...
ADFEA_DIR=/user/${USER_NAME}/naga_interactive/ocpc_ecom/model_train${JOB_TAG}/shitu/adfea/
ADFEA_PATH=$ADFEA_DIR/${DATE}/
INS_DIR=/user/${USER_NAME}/naga_interactive/ocpc_ecom/model_train${JOB_TAG}/shitu/ins/
INS_PATH=$INS_DIR/${DATE}/
STATINFO_DIR=/user/${USER_NAME}/naga_interactive/ocpc_ecom/model_train${JOB_TAG}/shitu/statinfo/
STATINFO_PATH=$STATINFO_DIR/${DATE}/
PLANCLKTRANS_DIR=/user/${USER_NAME}/naga_interactive/ocpc_ecom/model_train${JOB_TAG}/shitu/planclktrans/
