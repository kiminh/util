...
hdfs_log_path=/user/ad_user/naga_interactive/ocpc_ecom
...
clear_daily_data $hdfs_log_path/model_train/shitu/planclktrans $reserve_file_time
...
# clear_daily_data $hdfs_log_path/hour_model_train/planclktrans $reserve_hourly_file_time
