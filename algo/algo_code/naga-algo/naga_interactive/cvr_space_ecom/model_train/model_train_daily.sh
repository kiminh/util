...
SHITU_PATH="/user/${USER_NAME}/naga_interactive/ocpc_ecom/model_train${JOB_TAG}/shitu/ins/"
...
[ $? -ne 0 ] && { alarm "Naga Interactive DSP Ecom CVR Model" "hadoop fs cat error!"; exit 1; }
...
[ $? -ne 0 ] && { alarm "Naga Interactive DSP Ecom CVR Model" "[$VERSION] model train error!"; exit 1; }
