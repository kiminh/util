...
hdfs_shitu_ins_path=/user/${USER_NAME}/ocpc_ecom/model_train/shitu/ins/
...
./ftrl/bin/ftrl ${shitu_ins} alpha=0.05 beta=1 l1_reg=0.1 l2_reg=0. \
...
$HADOOP_HOME/bin/hadoop fs -cat /user/$USER_NAME/ocpc_ecom/model_train/shitu/planclktrans/$file_time_flag/* > ./model/calibrate.dat
