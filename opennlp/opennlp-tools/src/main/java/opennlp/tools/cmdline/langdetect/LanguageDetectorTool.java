    ...
    if (0 == args.length) {
      ...
      try {
        ...
        while ((document = documentStream.read()) != null) {
          ...
          JSONObject dataJson = JSONObject.parseObject(document);
          
          String inputtext = dataJson.getString("read_more");
 
          Language lang = langDetectME.predictLanguage(inputtext);

          LanguageSample sample = new LanguageSample(lang, inputtext);

          dataJson.put("language", sample.toString());
