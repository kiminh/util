...
if __name__ == '__main__':
    ...
    seed_user_df = spark.read.json(seed_user_df)
    ...
    appusage_data_df = appusage_data_df.withColumn('user_vect', 
        vector_mean_udf('features_sum', 'tfidf_sum'))
    appusage_data_df.show()
    appusage_data_df = appusage_data_df.select('gaid', 'user_vect')
    ...
    appusage_data_df.select('gaid', 'user_vect', 'label').write.json(des_path + '/json', "overwrite")
