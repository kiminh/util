...
USAGE_PATH="/user/ling.fang/1/2/3/4/5/automated_targeting/input/usage_tfidf/json"
APPS_VECT_PATH="/user/ling.fang/1/2/3/4/5/automated_targeting/apps_vector_tmp/json"
DES_PATH="/user/ling.fang/1/2/3/4/5/automated_targeting/input/user_interest_vec/"
...
$sparksubmit ${JOB_PATH}/gen_user_interest_vec.py $USAGE_PATH $APPS_VECT_PATH $DES_PATH
