...
DES_PATH="/user/ling.fang/1/2/3/4/5/automated_targeting/matrix/user_applist_online/"
...
$sparksubmit ${JOB_PATH}/get_user_applist.py $APPDB_PATH $DES_PATH $start_time $end_time
