...
FEA_VEC_PATH="/user/ling.fang/1/2/3/4/5/automated_targeting/matrix/$country/$obj_pkg_name/lookalike_samples_online/json"
OUT_RESULT_PATH="/user/ling.fang/1/2/3/4/5/automated_targeting/matrix/$country/$obj_pkg_name/lookalike_result_online/"
...
$sparksubmit ${JOB_PATH}/model_train.py $FEA_VEC_PATH $OUT_RESULT_PATH $obj_pkg_name
