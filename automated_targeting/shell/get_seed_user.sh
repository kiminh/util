...
SRC_PATH="/user/ling.fang/1/2/3/4/5/automated_targeting/matrix/appinstall_online/json"
APPS_VECT_PATH="/user/ling.fang/1/2/3/4/5/automated_targeting/apps_vector_tmp/json"
DES_PATH="/user/ling.fang/1/2/3/4/5/automated_targeting/matrix/$country/$obj_pkg_name/seed_user_online"
...
$sparksubmit ${JOB_PATH}/get_seed_user.py $SRC_PATH $APPS_VECT_PATH $obj_pkg_name $country $DES_PATH
