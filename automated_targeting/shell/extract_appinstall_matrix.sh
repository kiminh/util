...
DES_PATH="/user/ling.fang/1/2/3/4/5/automated_targeting/matrix/appinstall_online/"
...
$sparksubmit ${JOB_PATH}/extract_appinstall_matrix.py $APPDB_PATH $DES_PATH $start_time $end_time
