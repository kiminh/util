...
OJB_PKG_PATH="//user/ling.fang/1/2/3/4/5/automated_targeting/obj_pkg_path/newsbreak/"
...
$sparksubmit script/model_predict_online_evaluate.py $CF_MODEL_PATH $TEST_DATA_PATH $SI_MODEL_PATH $OJB_PKG_PATH $USAGE_PATH $DES_PATH
