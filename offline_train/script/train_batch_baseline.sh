...
#get shitu log
start_time_stamp="2017042409"
end_time_stamp="2017042410"
batch_shitu_log="./shitu_log/shitu.log"

adfea_conf=./conf/run.conf
ftrl_conf=./conf/ftrl_bl.conf
...
#adfea
adfea_fea_conf="./conf/fea_list_baseline.conf"
adfea_train_file=${batch_shitu_log}
adfea_train_instance="./shitu_ins/shitu.ins.bl"
...
ftrl_train_instance="./shitu_ins/shitu.train.bl"
ftrl_valid_instance="./shitu_ins/shitu.test.bl"
...
echo "model_file=model_bl.dat" >> ${ftrl_conf}
echo "predict_out=result_bl.dat" >> ${ftrl_conf}
...
#cal metric
python ./bin/cal_metric.py result_bl.dat
